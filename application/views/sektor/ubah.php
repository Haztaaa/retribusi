    ...
    <div class="container-fluid dashboard-content">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ubah sektor</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    <h5 class="card-header">ubah Data sektor</h5>
                    <?= $this->session->flashdata('message'); ?>
                    <div class="card-body">
                        <?php echo form_open_multipart('sektor/ubah/' . $sektor['id_sektor'], 'id="myForm"'); ?>
                        <div class="form-group">
                            <label for="inputText3" class="col-form-label"> Nama sektor</label>
                            <input id="inputText3" type="text" name="nama_sektor" class="form-control" value="<?= $sektor['nama_sektor'] ?>">
                            <?= form_error('nama_sektor', '<small class="text-danger pl-3">', '</small>'); ?>
                        </div>

                        <div class="form-group">
                            <label for="inputText3" class="col-form-label">Tagihan</label>
                            <input id="inputText3" type="text" name="tagihan" class="form-control" value="<?= $sektor['tagihan'] ?>">
