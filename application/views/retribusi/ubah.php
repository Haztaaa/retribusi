    ...
    <div class="container-fluid dashboard-content">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Ubah Setoran</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    <h5 class="card-header">Ubah Data Retribusi (Lunas)</h5>
                    <?= $this->session->flashdata('message'); ?>
                    <div class="card-body">
                    <?php echo form_open_multipart('retribusilunas/ubah/'.$pedagang['id_setoran'], 'id="myForm"'); ?>
                             
                            <div class="form-group">
                                <label for="inputText3" class="col-form-label">Nama Pedagang</label>
                                <input id="alamat" type="text" name="" class="form-control" value="<?= $pedagang['nama_pedagang']?>" readonly >
                                <?= form_error('', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="inputText3" class="col-form-label">Alamat</label>
                                <input id="alamat" type="text" name="alamat" class="form-control" value="<?= $pedagang['alamat']?>" readonly>
                                <?= form_error('alamat', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="inputText3" class="col-form-label">No Lapak</label>
                                <input id="no_lapak" type="text" name="no_lapak" class="form-control" value="<?= $pedagang['no_lapak']?>" readonly>
                                <?= form_error('no_lapak', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="inputText3" class="col-form-label">Sektor</label>
                                <input id="sektor" type="text" name="sektor" class="form-control" value="<?= $pedagang['sektor']?>" readonly>
                                <?= form_error('sektor', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="inputText3" class="col-form-label">Tanggal pembayaran</label>
                                <input id="inputText3" type="date" name="tgl_pembayaran" class="form-control" value="<?= $pedagang['tgl_pembayaran']?>">
                                <?= form_error('tgl_pembayaran', '<small class="text-danger pl-3">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label for="inputText3" class="col-form-label">Jumlah</label>
                                <input id="inputText3" type="text" name="jumlah" class="form-control" value="<?= $pedagang['jumlah']?>">
