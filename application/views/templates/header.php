    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <img src="<?= base_url() ?>assets/images/logo1.jpeg" style="width:80; height:60px" class="ml-4">
                <a class="navbar-brand" style="color:#A51919;" href="<?= base_url('beranda_a') ?>">P A S A R</a>
                <a style="color:#A51919; margin-left:-150px; margin-top:30px;">M A N A D O</a>
