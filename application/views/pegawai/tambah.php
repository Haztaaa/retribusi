        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <?php echo form_open_multipart('pegawai/tambah', 'id="myForm"'); ?>
                        <div class="form-group">
                            <label for="inputText3" class="col-form-label"> Nama pegawai</label>
                            <input id="inputText3" type="text" name="nama_pegawai" class="form-control">
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputText3" type="text" name="no_hp" class="form-control">
